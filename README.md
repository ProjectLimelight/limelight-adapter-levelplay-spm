# Limelight iOS SDK LevelPlay Adapter

Limelight iOS SDK LevelPlay Adapter for Swift Package Manager.
...
```swift
dependencies: [
    .package(url: "https://github.com/limelight-adapter-levelplay-spm.git", .upToNextMajor(from: "1.0.0"))
]
```
